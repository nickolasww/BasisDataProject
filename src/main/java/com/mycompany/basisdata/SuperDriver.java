 ...
 * @author sawun
 */
public class SuperDriver extends javax.swing.JFrame {

    /**
     * Creates new form SuperDriver
     */
    public SuperDriver() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Name ", "Phone", "Email", "Salary", "Rating", "Plat"
            }
        ));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SuperDriver.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SuperDriver().setVisible(true);
            }
        });
    }
