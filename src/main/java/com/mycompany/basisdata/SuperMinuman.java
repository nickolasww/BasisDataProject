 ...
 * @author sawun
 */
public class SuperMinuman extends javax.swing.JFrame {

    /**
     * Creates new form SuperMinuman
     */
    public SuperMinuman() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Name", "Category", "Description", "Status", "Price"
            }
        ));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SuperMinuman.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SuperMinuman().setVisible(true);
            }
        });
    }
